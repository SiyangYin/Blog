    ...
    d.directive("tagsInput", ["$timeout", "$document", "$window", "$q", "tagsInputConfig", "tiUtil", function (d, e, f, g, h, i) {
        function j(a, b, c, d) {
            ...
            return e = function (b) {
                ...
                var d = e(b), f = d && d.length >= a.minLength && d.length <= a.maxLength && a.allowedTagsPattern.test(d) && !i.findInObjectArray(k.items, b, a.keyProperty || a.displayProperty);
        ...
        return {
            ...
            link: function (b, c, g, h) {
                var j, k, l = [a.enter, a.comma, a.space, a.backspace, a["delete"], a.left, a.right], m = b.tagList, n = b.events, o = b.options, p = c.find("input"), q = ["minTags", "maxTags", "allowLeftoverText"];
                j = function () {
                    ...
                    a ? (m.items = i.makeObjectArray(a, o.displayProperty), b.tags = m.items) : m.items = []
                    ...
                    input: {
                        keydown: function (a) {
                            ...
                            d(function () {
                                var a = e.prop("activeElement"), d = a === p[0], f = c[0].contains(a);
                    ...
                    if (o.addOnPaste) {
                        var b = a.getTextData(), c = b.split(o.pasteSplitPattern);
        ...
        return {
            ...
            link: function (b, c, d, e) {
                var f, h = [a.enter, a.tab, a.escape, a.up, a.down], j = b.suggestionList, k = e.registerAutocomplete(), l = b.options, m = b.events;
        ...
        return c.debounce = function (b, c) {
            ...
            if (!b)return a;
            a = c.encodeHTML(a), b = c.encodeHTML(b);
